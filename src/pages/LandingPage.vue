...
#so-funktioniert-headers {
  padding-left: 10%;
  text-align: left;
}

#so-funktioniert-headers h4 {
  padding-top: 6%;
  color: #004c45;
}
...
.so-funktioniert-vectors {
  margin: 8% 4% 0 4%;
}

.so-funktioniert-vectors img {
  height: 50%;
  margin-bottom: 4em;
}

.so-funktioniert-vectors h4 {
  font-size: 1.4em;
}
